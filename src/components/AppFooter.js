    ...
    return(
        <footer className='text-light py-5'>
            <div className='container'>
                <ul className='links d-flex justify-content-center align-items-center gap-4'>
                    <li><a href='https://example.com'>Register</a></li>
                    <li><a href='https://example.com'>Forum</a></li>
                    <li><a href='https://example.com'>Affiliate</a></li>
                    <li><a href='https://example.com'>FAQ</a></li>
                </ul>
                <ul className='social-media d-flex justify-content-center align-items-center gap-3 mb-5'>
                ...
                <p className='text-light'>© {copyrightYear}. Foodera. All rights reserved. Coded By Mennat-Allah</p>
            </div>
        </footer>
    )
}
